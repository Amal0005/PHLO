...
export default function StatusModal({ isOpen, onClose, status, message, reason }: StatusModalProps) {
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
            <div className="bg-zinc-900 w-full max-w-md rounded-2xl p-8 border border-white/10 relative shadow-2xl">
                ...
                <div className="text-center mb-6">
                    <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${status === 'rejected' ? 'bg-red-500/10' : 'bg-yellow-500/10'
                        }`}>
                        {status === 'rejected' ? (
