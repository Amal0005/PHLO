    ...
    try {
      ...
      if (!authHeader) {
        return res
          ...
          .json({ message: MESSAGES.AUTH.AUTHORIZATION_HEADER_MISSING });
      }
      ...
      if (typeof exp !== "number") {
        return res
          ...
          .json({ message: MESSAGES.AUTH.TOKEN_EXPIRY_MISSING });
      }
      ...
      const message =
        error instanceof Error ? error.message : MESSAGES.AUTH.LOGOUT_FAILED;
