import { LeaveDocument, LeaveMapper } from "@/application/mapper/creator/creatorLeaveMapper";
...
export class LeaveRepository extends BaseRepository<LeaveEntity,LeaveDocument > implements ILeaveRepository{
  constructor(){
    super(LeaveModel)
  }
    protected mapToEntity(doc: LeaveDocument): LeaveEntity {
